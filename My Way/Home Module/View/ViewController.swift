...
class HomeViewController: UIViewController {
    ...
    @IBAction func redValueChanged(_ sender: UISlider) {
        print("red value : \(sender.value)")
        // FIXME: Complete me so the value changed will affect the UI, by simply activate the breakpoint on the left
    }
    @IBAction func greenValueChanged(_ sender: UISlider) {
        print("green value : \(sender.value)")
        // FIXME: Complete me so the value changed will affect the UI, by simply activate the breakpoint on the left
    }
    @IBAction func blueValueChanged(_ sender: UISlider) {
        print("blue value : \(sender.value)")
        // FIXME: Complete me so the value changed will affect the UI, by simply activate the breakpoint on the left
    }
